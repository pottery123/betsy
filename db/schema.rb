...
ActiveRecord::Schema.define(version: 20160510205409) do
  ...
  create_table "orders", force: :cascade do |t| #require fields
    t.integer  "user_id"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.string   "address"
    t.string   "name_on_cc"
    t.integer  "security_on_cc"
    t.datetime "expiration_on_cc" #dont use date time
    t.integer  "zip"
    t.string   "email"
    t.string   "status"
    t.integer  "order_id"

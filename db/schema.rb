...
ActiveRecord::Schema.define(version: 20160512204616) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.string   "name_on_cc",         null: false
    t.string   "security_on_cc",     null: false
    t.string   "expiration_on_cc",   null: false
